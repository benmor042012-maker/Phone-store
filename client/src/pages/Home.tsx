  ...
  return (
    <div className={`store-page ${highContrast ? "high-contrast" : ""}`} dir="rtl" style={largeText ? { fontSize: "112%" } : undefined}>
      ...
      <header className="store-header">
        <a href="#top" className="logo-link" aria-label="Phone Store"><img style={{ width: 190, height: 190 }} src="/manus-storage/phone-store-logo_3bb02528.png" alt="PHONE STORE" /></a>
