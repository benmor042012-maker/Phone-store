...
import { categoryImage, onImageError, productImage } from "@/lib/images";
...
const fallbackProducts: Product[] = [
  { id: "3", brand: "Apple", name: "AirPods Pro 2", category: "אוזניות", price: 799, oldPrice: 899, image: productImage("3"), badge: "מבצע", facts: [["סוללה", "עד 6 שעות"], ["טעינה", "MagSafe"], ["עמידות", "IPX4"]] },
  { id: "11", brand: "Anker", name: "כבל USB-C קלוע 2 מטר", category: "כבלים", price: 69, oldPrice: 89, image: productImage("11"), badge: "מבצע", facts: [["אורך", "2 מטר"], ["תמיכה", "100W"]] },
  { id: "12", brand: "Apple", name: "מגן מסך זכוכית מחוסמת", category: "מגני מסך", price: 79, image: productImage("12"), facts: [["עובי", "0.33 מ״מ"], ["קשיות", "9H"]] },
  { id: "9", brand: "Anker", name: "Anker PowerCore 20000", category: "סוללות גיבוי", price: 229, oldPrice: 279, image: productImage("9"), badge: "מבצע", facts: [["קיבולת", "20,000mAh"], ["הספק", "30W"], ["יציאות", "2"]] },
  { id: "1", brand: "Apple", name: "iPhone 17 Pro Max 256GB", category: "טלפונים סלולריים", price: 4900, oldPrice: 5400, image: productImage("1"), badge: "מבצע", facts: [["מעבד", "A18 Pro"], ["מסך", "6.9 אינץ׳"], ["אחסון", "256GB"]] },
  { id: "13", brand: "Apple", name: "כיסוי סיליקון MagSafe", category: "כיסויים", price: 139, image: productImage("13"), facts: [["חומר", "סיליקון"], ["תאימות", "MagSafe"]] },
  { id: "8", brand: "Samsung", name: "Samsung Galaxy Watch 7", category: "שעונים חכמים", price: 1299, image: productImage("8"), badge: "חדש", facts: [["מסך", "44 מ״מ"], ["סוללה", "עד 40 שעות"]] },
  { id: "5", brand: "Apple", name: "Apple Watch Ultra 2", category: "שעונים חכמים", price: 3299, oldPrice: 3599, image: productImage("5"), badge: "מבצע", facts: [["מסך", "49 מ״מ"], ["סוללה", "עד 72 שעות"], ["עמידות", "100 מטר"]] },
  { id: "2", brand: "Samsung", name: "Samsung Galaxy S25 Ultra", category: "טלפונים סלולריים", price: 4799, oldPrice: 5299, image: productImage("2"), badge: "מבצע", facts: [["מעבד", "Snapdragon 8 Elite"], ["מסך", "6.9 אינץ׳"], ["אחסון", "512GB"]] },
  { id: "10", brand: "Anker", name: "מטען קיר 65W USB-C", category: "מטענים", price: 169, image: productImage("10"), facts: [["הספק", "65W"], ["יציאות", "2 × USB-C"]] },
  { id: "14", brand: "Sony", name: "Sony WH-1000XM5", category: "אוזניות", price: 1449, oldPrice: 1699, image: productImage("14"), badge: "מבצע", facts: [["סוללה", "30 שעות"], ["חיבור", "Bluetooth 5.2"]] },
  { id: "4", brand: "Apple", name: "iPad Pro M4 11\"", category: "טאבלטים", price: 4299, image: productImage("4"), badge: "חדש", facts: [["מעבד", "M4"], ["מסך", "11 אינץ׳ OLED"], ["אחסון", "256GB"]] },
  { id: "6", brand: "Xiaomi", name: "Xiaomi 14 Ultra", category: "טלפונים סלולריים", price: 3499, image: productImage("6"), badge: "חדש", facts: [["מעבד", "Snapdragon 8 Gen 3"], ["מסך", "6.73 אינץ׳"], ["מצלמה", "Leica 50MP"]] },
  { id: "7", brand: "Google", name: "Google Pixel 9 Pro", category: "טלפונים סלולריים", price: 3999, image: productImage("7"), badge: "חדש", facts: [["מעבד", "Tensor G4"], ["מסך", "6.3 אינץ׳"], ["אחסון", "256GB"]] },
  { id: "15", brand: "OnePlus", name: "OnePlus 13", category: "טלפונים סלולריים", price: 3199, image: productImage("15"), badge: "חדש", facts: [["מעבד", "Snapdragon 8 Elite"], ["טעינה", "100W"], ["אחסון", "256GB"]] },
];
...
function toInventoryItem(entry: { id: string; img: string | null; name: string; brand: string; cat: string; price: number; was: number | null; tag: string; specs: Record<string, string | number>; desc: string }, categoryNames: Map<string, string>): Product {
  ...
  return {
    ...
    image: entry.img ?? productImage(entry.id),
...
export default function Home() {
  ...
  const products = useMemo(() => {
    ...
    return live.map((entry) => toInventoryItem(entry, categoryNames));
  }, [liveStorefront]);
